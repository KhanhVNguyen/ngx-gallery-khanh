...
var NgxGalleryPreviewComponent = /** @class */ (function () {
     ...
     * @return {?}
     */
    NgxGalleryPreviewComponent.prototype.handleClick = function (event) {
...
var GocodeeGalleryComponent$1 = /** @class */ (function () {
    ...
    GocodeeGalleryComponent$$1.propDecorators = {
        ...
        'preview': [{ type: ViewChild, args: [NgxGalleryPreviewComponent,] },],
        'image': [{ type: ViewChild, args: [NgxGalleryImageComponent,] },],
        'thubmnails': [{ type: ViewChild, args: [NgxGalleryThumbnailsMobileComponent$1,] },],
        'width': [{ type: HostBinding, args: ['style.width',] },],
        'height': [{ type: HostBinding, args: ['style.height',] },],
        'left': [{ type: HostBinding, args: ['style.left',] },],
        'onResize': [{ type: HostListener, args: ['window:resize',] },],
...
export { CustomHammerConfig, NgxGalleryModuleGoCodee, NgxGalleryComponent, GocodeeGalleryComponent$1 as GocodeeGalleryComponent, NgxGalleryActionComponent, NgxGalleryImageComponent, NgxGalleryThumbnailsComponent, NgxGalleryThumbnailsMobileComponent$1 as NgxGalleryThumbnailsMobileComponent, NgxGalleryPreviewComponent, NgxGalleryArrowsComponent, NgxGalleryOptions, NgxGalleryImage, NgxGalleryAnimation, NgxGalleryHelperService, NgxGalleryImageSize, NgxGalleryLayout, NgxGalleryOrder, NgxGalleryOrderedImage, NgxGalleryAction };
